	...
	<div class="d-flex justify-content-between">
		<div>
			<button
				...
				onclick="document.getElementById('gameForm').reset()">
		...
		<div>
			...
			<button class="btn btn-primary" onclick="window.location.href='/export.php'">
		...
		<?php foreach ($games as $game): ?>
			<div class="card" style="width: 350px; margin: 5px; display:inline-block; vertical-align: top;">
				...
				<?php if (empty($game->getImages())): ?>
					<span
						class="text-center"
						id="image<?= $game->getGameID() ?>" data-name="<?= $game->getGameName() ?>">
